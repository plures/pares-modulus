    ...
    {:else}
      <Box class="widget__content">
        ...
        <Box class="net-worth__primary" direction="row" align="center" gap="var(--space-2, 0.5rem)">
          <Text
            class={{
              'net-worth__value': true,
              'net-worth__value--positive': netWorth >= 0,
              'net-worth__value--negative': netWorth < 0,
            }}
          ...
          {#if trend !== 'neutral'}
            <Text
              class={{
                'net-worth__trend': true,
                'net-worth__trend--up': trend === 'up',
                'net-worth__trend--down': trend === 'down',
              }}
